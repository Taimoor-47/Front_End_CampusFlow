...
| Next recommended task | Begin P0-07 in bounded chunks: rate-limit login/register endpoints and review the cookie `SameSite=None` CSRF posture. Quick-win alternative first: P0-10 (delete dead frontend service files). |
